...
var St = class {
  ...
  abort(t2) {
    t2 && this.T.reject(t2), this.aborted || (O2("SimpleDb", "Aborting transaction:", t2 ? t2.message : "Client-initiated abort"), this.aborted = true, this.transaction.abort());
  }
  R() {
...
var Dt = class {
  constructor(t2, e, n) {
    ...
    12.2 === Dt.v(getUA()) && F2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  static delete(t2) {
...
var $t = class {
  ...
  Z(t2) {
    O2("IndexBackiller", `Scheduled in ${t2}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", t2, async () => {
      this.task = null;
      try {
        O2("IndexBackiller", `Documents written: ${await this.X.tt()}`);
      } catch (t3) {
...
var Bt = class {
  ...
  et(t2, e) {
    ...
    return Vt.doWhile(() => true === i && s > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(t2).next((e2) => {
      if (null !== e2 && !n.has(e2))
        return O2("IndexBackiller", `Processing collection: ${e2}`), this.nt(t2, e2, s).next((t3) => {
          s -= t3, n.add(e2);
        });
      i = false;
    })).next(() => e - s);
  ...
  nt(t2, e, n) {
    return this.localStore.indexManager.getMinOffsetFromCollectionGroup(t2, e).next((s) => this.localStore.localDocuments.getNextDocuments(t2, e, s, n).next((n2) => {
      const i = n2.changes;
      return this.localStore.indexManager.updateIndexEntries(t2, i).next(() => this.st(s, n2)).next((n3) => (O2("IndexBackiller", `Updating offset: ${n3}`), this.localStore.indexManager.updateCollectionGroup(t2, e, n3))).next(() => i.size);
    }));
  }
  st(t2, e) {
    let n = t2;
...
function Ws(t2, e) {
  ...
  if ("targetChange" in e) {
    ...
    const s = function(t3) {
      ...
      return t3.dt ? (U2(void 0 === e2 || "string" == typeof e2), Xt.fromBase64String(e2 || "")) : (U2(void 0 === e2 || e2 instanceof Uint8Array), Xt.fromUint8Array(e2 || new Uint8Array()));
...
var ur = class {
  ...
  oe(t2, e) {
    if ("nullValue" in t2)
      ...
      "mapValue" in t2 ? ve(t2) ? this.ce(e, Number.MAX_SAFE_INTEGER) : (this.we(t2.mapValue, e), this.fe(e)) : "arrayValue" in t2 ? (this.me(t2.arrayValue, e), this.fe(e)) : L2();
  }
  le(t2, e) {
...
var Tr = class {
  ...
  getMinOffset(t2, e) {
    return Vt.mapArray(this.Ye(e), (e2) => this.Xe(t2, e2).next((t3) => t3 || L2())).next(Pr);
  }
};
function Er(t2) {
...
var Cr = class {
  ...
  lookupMutationBatch(t2, e) {
    return Nr(t2).get(e).next((t3) => t3 ? (U2(t3.userId === this.userId), Hi(this.wt, t3)) : null);
  }
  yn(t2, e) {
  ...
  getNextMutationBatchAfterBatchId(t2, e) {
    ...
    return Nr(t2).J({
      ...
      e2.userId === this.userId && (U2(e2.batchId >= n), i = Hi(this.wt, e2)), s2.done();
    }).next(() => i);
  }
    ...
    return kr(t2).J({
      ...
      if (o === this.userId && e.path.isEqual(a))
        return Nr(t2).get(c).next((t3) => {
          if (!t3)
            throw L2();
          U2(t3.userId === this.userId), i.push(Hi(this.wt, t3));
        });
      r.done();
    }).next(() => i);
  }
  ...
  pn(t2, e) {
    ...
    return e.forEach((e2) => {
      s.push(Nr(t2).get(e2).next((t3) => {
        if (null === t3)
          throw L2();
        U2(t3.userId === this.userId), n.push(Hi(this.wt, t3));
      }));
    }), Vt.waitFor(s).next(() => n);
  }
...
var Fr = class {
  ...
  removeTargetData(t2, e) {
    return this.removeMatchingKeysForTargetId(t2, e.targetId).next(() => $r(t2).delete(e.targetId)).next(() => this.bn(t2)).next((e2) => (U2(e2.targetCount > 0), e2.targetCount -= 1, this.Pn(t2, e2)));
  }
...
var Kr = class {
  ...
  kn(t2) {
    O2("LruGarbageCollector", `Garbage collection scheduled in ${t2}ms`), this.Nn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", t2, async () => {
      this.Nn = null;
      try {
  ...
  Qs(t2, e) {
    ...
    return n.K().next((t3) => {
      ...
      return t3.forEach((t4) => {
        ...
        const r = new C2(n3), o = rr.se(this.wt, r), u = i.getIndexManager(r), c = Cr.se(r, this.wt, u, i.referenceDelegate);
...
var po = class {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 15) {
    ...
    this.referenceDelegate = new Qr(this, s), this.ei = e + "main", this.wt = new Ki(u), this.ni = new Dt(this.ei, this.Hs, new mo(this.wt)), this.Vs = new Fr(this.referenceDelegate, this.wt), this.remoteDocumentCache = Hr(this.wt), this.Ds = new nr(), this.window && this.window.localStorage ? this.si = this.window.localStorage : (this.si = null, false === a && F2("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  start() {
    return this.ii().then(() => {
  ...
  runTransaction(t2, e, n) {
    ...
    const s = "readonly" === e ? "readonly" : "readwrite", i = 15 === (r = this.Hs) ? Oi : 14 === r ? Mi : 13 === r ? ki : 12 === r ? Ni : 11 === r ? xi : void L2();
    var r;
    let o;
    return this.ni.runTransaction(t2, s, i, (s2) => (o = new Fi(s2, this.Ps ? this.Ps.next() : Lt.ot), "readwrite-primary" === e ? this.ai(o).next((t3) => !!t3 || this.hi(o)).next((e2) => {
      if (!e2)
        throw F2(`Failed to obtain primary lease for action '${t2}'.`), this.isPrimary = false, this.js.enqueueRetryable(() => this.ti(false)), new Q2(G.FAILED_PRECONDITION, bt);
      return n(o);
  ...
  li(t2) {
    const e = Io(t2);
    return e.get("owner").next((t3) => this.di(t3) ? (O2("IndexedDbPersistence", "Releasing primary lease."), e.delete("owner")) : Vt.resolve());
  }
  mi(t2, e) {
    const n = Date.now();
...
var Ro = class {
  ...
  xi(t2, e, n, s) {
    return cn(e) || s.isEqual(ct.min()) ? this.Ni(t2, e) : this.Di.getDocuments(t2, n).next((i) => {
      const r = this.ki(e, i);
      return this.Mi(e, r, n, s) ? this.Ni(t2, e) : (k2() <= LogLevel.DEBUG && O2("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), gn(e)), this.Oi(t2, r, e, Tt(s, -1)));
    });
  }
  ki(t2, e) {
    let n = new Wt(In(t2));
  ...
  Ni(t2, e) {
    return k2() <= LogLevel.DEBUG && O2("QueryEngine", "Using full collection scan to execute query:", gn(e)), this.Di.getDocumentsMatchingQuery(t2, e, At.min());
  }
  Oi(t2, e, n, s) {
...
var eu = class extends class {
  ...
  ro(t2, e, n, s, i) {
    ...
    const o = {};
    return this.uo(o, s, i), this.co(t2, r, o, n).then((t3) => (O2("RestConnection", "Received: ", t3), t3), (e2) => {
...
var ru = class {
  ...
  Io(t2) {
    ...
    s > 0 && O2("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.wo} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), this.mo = this.js.enqueueAfterDelay(this.timerId, s, () => (this.yo = Date.now(), t2())), this.wo *= this.fo, this.wo < this.lo && (this.wo = this.lo), this.wo > this._o && (this.wo = this._o);
  }
  Eo() {
...
var ou = class {
  ...
  Lo(t2) {
    return (e) => {
      this.js.enqueueAndForget(() => this.Po === t2 ? e() : (O2("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve()));
    };
  }
};
...
async function bu(t2, e, n) {
  ...
  t2.lu.add(1), await du(t2), t2._u.set("Offline"), n || (n = () => So(t2.localStore)), t2.asyncQueue.enqueueRetryable(async () => {
    O2("RemoteStore", "Retrying IndexedDB access"), await n(), t2.lu.delete(1), await fu(t2);
  });
}
function Pu(t2, e) {
...
function Bu(t2) {
  return t2.gu || (t2.gu = function(t3, e, n) {
    ...
    e ? (t2.gu.No(), await vu(t2)) : (await t2.gu.stop(), t2.au.length > 0 && (O2("RemoteStore", `Stopping write stream with ${t2.au.length} pending writes`), t2.au = []));
  })), t2.gu;
}
var Lu = class {
  constructor(t2, e, n, s, i) {
...
var ec2 = class {
  constructor(t2, e, n) {
    this.xu = t2, this.localStore = e, this.wt = n, this.queries = [], this.documents = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = nc2(t2);
  }
  Nu(t2) {
  ...
  ku(t2) {
    const e = /* @__PURE__ */ new Map(), n = new tc2(this.wt);
    for (const s of t2)
  ...
  async complete() {
    const t2 = await Bo(this.localStore, new tc2(this.wt), this.documents, this.xu.id), e = this.ku(this.documents);
...
var rc2 = class {
  ...
  Wu() {
    ...
    const e = [];
    return t2.forEach((t3) => {
      this.Bu.has(t3) || e.push(new ic2(t3));
    }), this.Bu.forEach((n) => {
...
async function hc2(t2, e, n, s) {
  t2.hc = (e2, n2, s2) => async function(t3, e3, n3, s3) {
    ...
    return Ac2(t3, e3.targetId, o2.zu), o2.snapshot;
  }(t2, e2, n2, s2);
  const i = await Mo(
    t2.localStore,
    e,
    true
  ), r = new rc2(e, i.ji), o = r.Ku(i.documents), u = Ts.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" !== t2.onlineState), c = r.applyChanges(
    o,
    t2.isPrimaryClient,
    u
  );
...
async function wc2(t2, e, n) {
  ...
  if (r) {
    ...
    await dc2(s, i2), s.sc = s.sc.remove(r), s.ic.delete(e), bc2(s);
  } else
    await ko(
      s.localStore,
      e,
...
function Tc2(t2, e, n = null) {
  ...
  if (t2.ec.delete(e), t2.isPrimaryClient) {
    t2.rc.us(e).forEach((e2) => {
      t2.rc.containsKey(e2) || Ec2(t2, e2);
    });
  }
}
function Ec2(t2, e) {
  ...
  const n = t2.sc.get(e);
  null !== n && (wu(t2.remoteStore, n), t2.sc = t2.sc.remove(e), t2.ic.delete(n), bc2(t2));
}
function Ac2(t2, e, n) {
  for (const s of n)
    if (s instanceof sc2)
      t2.rc.addReference(s.key, e), Rc2(t2, s);
    else if (s instanceof ic2) {
      O2("SyncEngine", "Document no longer in limbo: " + s.key), t2.rc.removeReference(s.key, e);
      t2.rc.containsKey(s.key) || Ec2(t2, s.key);
    } else
      L2();
}
function Rc2(t2, e) {
  const n = e.key, s = n.path.canonicalString();
  t2.sc.get(n) || t2.nc.has(s) || (O2("SyncEngine", "New document in limbo: " + n), t2.nc.add(s), bc2(t2));
}
function bc2(t2) {
  for (; t2.nc.size > 0 && t2.sc.size < t2.maxConcurrentLimboResolutions; ) {
    ...
    t2.ic.set(s, new uc2(n)), t2.sc = t2.sc.insert(n, s), _u(t2.remoteStore, new qi(dn(un(n.path)), s, 2, Lt.ot));
  }
}
...
async function vc2(t2, e) {
  ...
  if (!n.currentUser.isEqual(e)) {
    ...
    }(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(e, t3.removedBatchIds, t3.addedBatchIds), await Pc2(n, t3.Ki);
  }
}
function Vc2(t2, e) {
...
async function Sc2(t2, e) {
  ...
  return n.isPrimaryClient && Ac2(n, e.targetId, i.zu), i;
}
async function Dc2(t2, e) {
  const n = K2(t2);
...
async function xc2(t2, e) {
  const n = K2(t2);
  if ($c2(n), Bc2(n), true === e && true !== n.ac) {
...
async function Nc2(t2, e, n) {
  ...
  for (const t3 of e) {
    ...
    if (n2 && 0 !== n2.length) {
      ...
      for (const t4 of n2) {
        const e3 = s.tc.get(t4), n3 = await Sc2(s, e3);
...
function $c2(t2) {
  const e = K2(t2);
  return e.remoteStore.remoteSyncer.applyRemoteEvent = dc2.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = Vc2.bind(null, e), e.remoteStore.remoteSyncer.rejectListen = wc2.bind(null, e), e.Zu.Go = Hu.bind(null, e.eventManager), e.Zu.lc = Ju.bind(null, e.eventManager), e;
}
function Bc2(t2) {
  const e = K2(t2);
...
function Lc2(t2, e, n) {
  ...
  (async function(t3, e2, n2) {
    try {
      ...
      const i = new ec2(s2, t3.localStore, e2.wt);
      let r = await e2.fc();
      for (; r; ) {
...
var qc2 = class extends Uc2 {
  ...
  async initialize(t2) {
    await super.initialize(t2), await this.yc.initialize(this, t2), await Bc2(this.yc.syncEngine), await vu(this.yc.remoteStore), await this.persistence.ci(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  wc(t2) {
    return Po(this.persistence, new Ro(), t2.initialUser, this.wt);
  }
...
var Kc2 = class extends qc2 {
  ...
  async initialize(t2) {
    ...
    this.sharedClientState instanceof Ho && (this.sharedClientState.syncEngine = {
      ...
      await xc2(this.yc.syncEngine, t3), this.gcScheduler && (t3 && !this.gcScheduler.started ? this.gcScheduler.start() : t3 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (t3 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : t3 || this.indexBackfillerScheduler.stop());
    });
  }
  dc(t2) {
    const e = nu();
...
var Gc2 = class {
  ...
  terminate() {
    return async function(t2) {
      const e = K2(t2);
      O2("RemoteStore", "RemoteStore shutting down."), e.lu.add(5), await du(e), e.du.shutdown(), e._u.set("Unknown");
    }(this.remoteStore);
  }
};
...
var jc2 = class {
  ...
  error(t2) {
    this.observer.error ? this.Ic(this.observer.error, t2) : F2("Uncaught Error in snapshot listener:", t2);
  }
  Tc() {
    this.muted = true;
  }
...
var zc2 = class {
  ...
  async lookup(t2) {
    ...
    const e = await async function(t3, e2) {
      const n = K2(t3), s = qs(n.wt) + "/documents", i = {
...
var Hc2 = class {
  ...
  Cc() {
    this.So.Io(async () => {
      const t2 = new zc2(this.datastore), e = this.xc(t2);
      e && e.then((e2) => {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      const s = await Mo(
        ...
        e2,
        true
      ), i = new rc2(e2, s.ji), r = i.Ku(s.documents), o = i.applyChanges(
        r,
        false
      );
...
var ba2 = class {
  constructor(t2, e, n) {
    this._authCredentials = e, this._appCheckCredentials = n, this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Ra2({}), this._settingsFrozen = false, t2 instanceof ue ? this._databaseId = t2 : (this._app = t2, this._databaseId = function(t3) {
...
function xa2(t2, e, ...n) {
  if (t2 = getModularInstance(t2), 1 === arguments.length && (e = st.I()), ga("doc", "path", e), t2 instanceof ba2) {
    const s = ht.fromString(e, ...n);
    return pa2(s), new va(
      t2,
      null,
...
var Ba = class extends ba2 {
  constructor(t2, e, n) {
    super(t2, e, n), this.type = "firestore", this._queue = new Ma2(), this._persistenceKey = "name" in t2 ? t2.name : "[DEFAULT]";
  }
  _terminate() {
...
var zh = class extends qh {
  ...
  _apply(t2) {
    return new Va2(t2.firestore, t2.converter, _n(t2._query, this.ma, this.ga));
  }
};
function Hh(t2) {
...
function Rl(t2, ...e) {
  ...
  return function(t3, e2, n2, s2) {
    ...
    return t3.asyncQueue.enqueueAndForget(async () => Wu(await ra2(t3), r2)), () => {
      i2.Tc(), t3.asyncQueue.enqueueAndForget(async () => zu(await ra2(t3), r2));
    };
  }(qa2(a), h, u, c);
}
function bl(t2, e) {
...
!function(t2, e = true) {
  !function(t3) {
    ...
    const s = t3.getProvider("app").getImmediate(), i = new Ba(s, new J2(t3.getProvider("auth-internal")), new tt(t3.getProvider("app-check-internal")));
    return n = Object.assign({
      useFetchStreams: e
    }, n), i._setSettings(n), i;
  }, "PUBLIC")), registerVersion(D2, "3.4.14", t2), registerVersion(D2, "3.4.14", "esm2017");
}();
export {
