...
var J2 = class {
  ...
  getToken() {
    ...
    return this.forceRefresh = false, this.auth ? this.auth.getToken(e).then((e2) => this.i !== t2 ? (M2("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : e2 ? (U2("string" == typeof e2.accessToken), new W2(e2.accessToken, this.currentUser)) : null) : Promise.resolve(null);
  }
  invalidateToken() {
...
var tt = class {
  ...
  start(t2, e) {
    const n = (t3) => {
      null != t3.error && M2("FirebaseAppCheckTokenProvider", `Error getting App Check token; using placeholder token instead. Error: ${t3.error.message}`);
  ...
  getToken() {
    ...
    return this.forceRefresh = false, this.appCheck ? this.appCheck.getToken(t2).then((t3) => t3 ? (U2("string" == typeof t3.token), this.p = t3.token, new Z2(t3.token)) : null) : Promise.resolve(null);
  }
  invalidateToken() {
    this.forceRefresh = true;
  }
...
var Vt = class {
  constructor(t2, e, n) {
    ...
    12.2 === Vt.v(getUA()) && F2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  static delete(t2) {
  ...
  async k(t2) {
    return this.db || (M2("SimpleDb", "Opening database:", this.name), this.db = await new Promise((e, n) => {
      ...
      s.onsuccess = (t3) => {
        ...
        "VersionError" === s2.name ? n(new Q2(G.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s2.name ? n(new Q2(G.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s2)) : n(new Dt(t2, s2));
...
var xt = class {
  ...
  put(t2, e) {
    let n;
    return void 0 !== e ? (M2("SimpleDb", "PUT", this.store.name, t2, e), n = this.store.put(e, t2)) : (M2("SimpleDb", "PUT", this.store.name, "<auto-key>", t2), n = this.store.put(t2)), Nt(n);
  }
  add(t2) {
  ...
  get(t2) {
    return Nt(this.store.get(t2)).next((e) => (void 0 === e && (e = null), M2("SimpleDb", "GET", this.store.name, t2, e), e));
  }
  delete(t2) {
...
var Ft = class {
  ...
  et(t2, e) {
    ...
    let s = e, i = true;
    return Pt.doWhile(() => true === i && s > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(t2).next((e2) => {
      if (null !== e2 && !n.has(e2))
...
function pn(t2, e, n) {
  const s = t2.field.isKeyField() ? dt.comparator(e.key, n.key) : function(t3, e2, n2) {
    ...
    return null !== s2 && null !== i ? _e(s2, i) : L2();
  }(t2.field, e, n);
  switch (t2.dir) {
    case "asc":
      return s;
...
function Qs(t2, e) {
  ...
  if ("targetChange" in e) {
    ...
    const s = function(t3) {
      ...
      return t3.dt ? (U2(void 0 === e2 || "string" == typeof e2), Jt.fromBase64String(e2 || "")) : (U2(void 0 === e2 || e2 instanceof Uint8Array), Jt.fromUint8Array(e2 || new Uint8Array()));
...
function Ws(t2, e) {
  const n = e.currentDocument ? function(t3) {
    return void 0 !== t3.updateTime ? $n.updateTime(Ns(t3.updateTime)) : void 0 !== t3.exists ? $n.exists(t3.exists) : $n.none();
  }(e.currentDocument) : $n.none(), s = e.updateTransforms ? e.updateTransforms.map((e2) => function(t3, e3) {
    let n2 = null;
    if ("setToServerValue" in e3)
      U2("REQUEST_TIME" === e3.setToServerValue), n2 = new vn();
...
function Zs(t2) {
  return t2 ? void 0 !== t2.unaryFilter ? [ri(t2)] : void 0 !== t2.fieldFilter ? [ii(t2)] : void 0 !== t2.compositeFilter ? t2.compositeFilter.filters.map((t3) => Zs(t3)).reduce((t3, e) => t3.concat(e)) : L2() : [];
}
function ti(t2) {
  return vs[t2];
}
...
function zi(t2) {
  const e = ji(t2.readTime), n = void 0 !== t2.lastLimboFreeSnapshotVersion ? ji(t2.lastLimboFreeSnapshotVersion) : ct.min();
  let s;
  var i;
  return void 0 !== t2.query.documents ? (U2(1 === (i = t2.query).documents.length), s = ln(rn(Bs(i.documents[0])))) : s = function(t3) {
    return ln(Ys(t3));
...
var sr = class {
  ...
  getOverlaysForCollection(t2, e, n) {
    const s = hs(), i = ci(e), r = IDBKeyRange.bound(
      [this.userId, i, n],
...
function dr(t2, e) {
  ...
  return 0 !== n ? n : (n = _r(t2.arrayValue, e.arrayValue), 0 !== n ? n : (n = _r(t2.directionalValue, e.directionalValue), 0 !== n ? n : dt.comparator(t2.documentKey, e.documentKey)));
}
function _r(t2, e) {
...
var pr = class {
        ...
        return Pt.forEach(i, (i2, r) => {
          ...
          const u = function(t4, e2) {
            ...
            for (const i3 of mt(e2)) {
              const e3 = 0 === i3.kind ? Le(t4, i3.fieldPath, t4.startAt) : Ue(t4, i3.fieldPath, t4.startAt);
            ...
            let s3 = true;
            for (const i3 of mt(e2)) {
              const e3 = 0 === i3.kind ? Ue(t4, i3.fieldPath, t4.endAt) : Le(t4, i3.fieldPath, t4.endAt);
              n2.push(e3.value), s3 && (s3 = e3.inclusive);
            }
            return new Ye(n2, s3);
  ...
  en(t2, e, n, s, i, r, o) {
    ...
    for (let h = 0; h < u; ++h) {
      const u2 = e ? this.nn(e[h / c]) : yr, l2 = this.sn(t2, u2, n[h % c], s), f = this.rn(t2, u2, i[h % c], r), d = o.map((e2) => this.sn(
        t2,
        u2,
        e2,
        true
  ...
  cn(t2, e) {
    return !!t2.filters.find((t3) => t3 instanceof qe && t3.field.isEqual(e) && ("in" === t3.op || "not-in" === t3.op));
  }
  getFieldIndexes(t2, e) {
  ...
  createRange(t2, e, n) {
    n = n.sort((t3, e2) => dr(t3, e2)).filter((t3, e2, n2) => !e2 || 0 !== dr(t3, n2[e2 - 1]));
    const s = [];
    s.push(t2);
    for (const i2 of n) {
...
var Or = class {
  ...
  bn(t2) {
    return Fr(t2).get("targetGlobalKey").next((t3) => (U2(null !== t3), t3));
  }
  Pn(t2, e) {
  ...
  removeMatchingKeysForTargetId(t2, e) {
    const n = $r(t2), s = IDBKeyRange.bound(
      [e],
      [e + 1],
      false,
      true
  ...
  containsKey(t2, e) {
    const n = ci(e.path), s = IDBKeyRange.bound(
      [n],
      [ot(n)],
      false,
      true
...
var qr = class {
  ...
  collect(t2, e) {
    return -1 === this.params.cacheSizeCollectionThreshold ? (M2("LruGarbageCollector", "Garbage collection skipped; disabled"), Pt.resolve(br)) : this.getCacheSize(t2).next((n) => n < this.params.cacheSizeCollectionThreshold ? (M2("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), br) : this.$n(t2, e));
  }
  getCacheSize(t2) {
...
var Kr = class {
  ...
  Ln(t2, e) {
    ...
    return n.J({
      ...
      0 === t3 ? (i !== $t.ot && e(new dt(li(s)), i), i = o, s = r) : i = $t.ot;
    }).next(() => {
...
var oo = class {
  ...
  removeMutationBatch(t2, e) {
    U2(0 === this.ys(e.batchId, "removed")), this.mutationQueue.shift();
    let n = this.ds;
...
var go = class {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 14) {
    ...
    this.referenceDelegate = new Kr(this, s), this.ei = e + "main", this.wt = new Ui(u), this.ni = new Vt(this.ei, this.Hs, new _o(this.wt)), this.Vs = new Or(this.referenceDelegate, this.wt), this.remoteDocumentCache = Wr(this.wt), this.Ds = new tr(), this.window && this.window.localStorage ? this.si = this.window.localStorage : (this.si = null, false === a && F2("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  start() {
    return this.ii().then(() => {
  ...
  hi(t2) {
    ...
    return yo(t2).get("owner").next((e) => {
      ...
      return !(!this.networkEnabled || !this.inForeground) || po(t2).K().next((t3) => void 0 === this.gi(t3, 5e3).find((t4) => {
  ...
  runTransaction(t2, e, n) {
    ...
    const s = "readonly" === e ? "readonly" : "readwrite", i = 15 === (r = this.Hs) ? ki : 14 === r ? Ni : 13 === r ? xi : 12 === r ? Ci : 11 === r ? Di : void L2();
    var r;
    let o;
    return this.ni.runTransaction(t2, s, i, (s2) => (o = new Oi(s2, this.Ps ? this.Ps.next() : $t.ot), "readwrite-primary" === e ? this.ai(o).next((t3) => !!t3 || this.hi(o)).next((e2) => {
      if (!e2)
...
var qo = class {
  ...
  static Ji(t2, e, n) {
    ...
    return r && s.error && (r = "string" == typeof s.error.message && "string" == typeof s.error.code, r && (i = new Q2(s.error.code, s.error.message))), r ? new qo(t2, e, s.state, i) : (F2("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
  }
  Yi() {
    const t2 = {
      state: this.state,
...
var Ko = class {
  ...
  static Ji(t2, e) {
    ...
    return i && n.error && (i = "string" == typeof n.error.message && "string" == typeof n.error.code, i && (s = new Q2(n.error.code, n.error.message))), i ? new Ko(t2, n.state, s) : (F2("SharedClientState", `Failed to parse target state for ID '${t2}': ${e}`), null);
  }
  Yi() {
    const t2 = {
      state: this.state,
...
var Qo = class {
  ...
  static Ji(t2) {
    ...
    return "object" == typeof e && -1 !== ["Unknown", "Online", "Offline"].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Qo(e.clientId, e.onlineState) : (F2("SharedClientState", `Failed to parse online state: ${t2}`), null);
  }
};
var jo = class {
  constructor() {
    ...
    return y2(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (i2) {
          ...
          void 0 === e3 && (e3 = G.INTERNAL, n3 = "Unknown error status: " + t4 + " with message " + i2.message), h = true, l2.eo(new Q2(e3, n3)), c.close();
        } else
...
var ou = class extends iu {
  ...
  onMessage(t2) {
    ...
    return U2(!t2.writeResults || 0 === t2.writeResults.length), this.Wo = true, this.listener.Yo();
  }
  Xo() {
    const t2 = {};
...
async function uc2(t2, e) {
  ...
  if (r)
    ...
    s = t3.targetId, i = await cc2(n, e, s, "current" === r2);
  }
  return i;
}
async function cc2(t2, e, n, s) {
  ...
  const i = await No(
    ...
    e,
    true
  ), r = new sc2(e, i.ji), o = r.Ku(i.documents), u = ps.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" !== t2.onlineState), c = r.applyChanges(
    o,
    t2.isPrimaryClient,
    u
  );
...
function Ic2(t2, e) {
  ...
  const n = t2.sc.get(e);
  null !== n && (du(t2.remoteStore, n), t2.sc = t2.sc.remove(e), t2.ic.delete(n), Ac2(t2));
}
function Tc2(t2, e, n) {
  for (const s of n)
    if (s instanceof ec2)
...
async function Sc2(t2, e, n, s) {
  ...
  null !== r ? ("pending" === n ? await bu(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (yc2(i, e, s || null), gc2(i, e), function(t3, e2) {
...
async function Dc2(t2, e) {
  const n = K2(t2);
  if (Mc2(n), Fc2(n), true === e && true !== n.ac) {
    ...
    n.ec.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i) ? t3.push(i) : e2 = e2.then(() => (pc2(n, i), xo(
        n.localStore,
        i,
        true
      ))), du(n.remoteStore, i);
...
async function Cc2(t2, e, n) {
  ...
  for (const t3 of e) {
    ...
    if (n2 && 0 !== n2.length) {
      ...
      e2 = await Co(s.localStore, n3), await cc2(
        s,
        xc2(n3),
        t3,
        false
...
async function kc2(t2, e, n, s) {
  ...
  if (r && r.length > 0)
    switch (n) {
      case "current":
      case "not-current": {
        const t3 = await Oo(i.localStore, gn(r[0])), s2 = ys.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
        await Rc2(i, t3, s2);
        break;
      }
      case "rejected":
...
var Lc2 = class extends Bc2 {
  ...
  _c(t2) {
    const e = Io(t2.databaseInfo.databaseId, t2.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? Pr.withCacheSize(this.cacheSizeBytes) : Pr.DEFAULT;
...
var qc2 = class {
  async initialize(t2, e) {
    this.localStore || (this.localStore = t2.localStore, this.sharedClientState = t2.sharedClientState, this.datastore = this.createDatastore(e), this.remoteStore = this.createRemoteStore(e), this.eventManager = this.createEventManager(e), this.syncEngine = this.createSyncEngine(
      e,
      !t2.synchronizeTabs
    ), this.sharedClientState.onlineStateHandler = (t3) => fc2(this.syncEngine, t3, 1), this.remoteStore.remoteSyncer.handleCredentialChange = bc2.bind(null, this.syncEngine), await Ou(this.remoteStore, this.syncEngine.isPrimaryClient));
  }
  ...
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      const s = await No(
        ...
        e2,
        true
      ), i = new sc2(e2, s.ji), r = i.Ku(s.documents), o = i.applyChanges(
        r,
        false
      );
...
function aa2(t2, e, n = {}) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2, n2, s2, i) {
    const r = new Gc2({
      next: (n3) => {
        e2.enqueueAndForget(() => ju(t3, o)), n3.fromCache && "server" === s2.source ? i.reject(new Q2(G.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n3);
      },
      error: (t4) => i.reject(t4)
    }), o = new Ju(n2, r, {
      includeMetadataChanges: true,
  ...
  _setSettings(t2) {
    ...
    this._settings = new Ea(t2), void 0 !== t2.credentials && (this._authCredentials = function(t3) {
      ...
      switch (t3.type) {
        case "gapi":
          const e = t3.client;
          return U2(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), new X2(e, t3.sessionIndex || "0", t3.iamToken || null);
        case "provider":
          return t3.client;
        default:
...
var va = class extends Pa {
  ...
  get parent() {
    ...
    return t2.isEmpty() ? null : new ba2(
      this.firestore,
      null,
      new dt(t2)
    );
...
function Da(t2, e, ...n) {
  if (t2 = getModularInstance(t2), 1 === arguments.length && (e = st.I()), wa("doc", "path", e), t2 instanceof Aa2) {
    const s = ht.fromString(e, ...n);
    return ga(s), new ba2(
      t2,
      null,
...
function qa2(t2, e) {
  ...
  return Ga2(n, i, new Lc2(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
function Ka2(t2) {
  Xa2(t2 = Ia2(t2, Fa2));
...
var wh = class extends nh {
  ...
  _toFieldTransform(t2) {
    const e = dh(
      ...
      t2,
      true
    ), n = this.ha.map((t3) => Th(t3, e)), s = new Vn(n);
...
var mh = class extends nh {
  ...
  _toFieldTransform(t2) {
    const e = dh(
      ...
      t2,
      true
    ), n = this.ha.map((t3) => Th(t3, e)), s = new Dn(n);
    return new On(t2.path, s);
  }
  isEqual(t2) {
    return this === t2;
...
function Ah(t2) {
  return !("object" != typeof t2 || null === t2 || t2 instanceof Array || t2 instanceof Date || t2 instanceof ut || t2 instanceof sh || t2 instanceof eh || t2 instanceof ba2 || t2 instanceof nh);
}
function Rh(t2, e, n) {
  if (!Ah(n) || !function(t3) {
...
function xh(t2, e) {
  return "string" == typeof e ? vh(t2, e) : e instanceof Za2 ? e._internalPath : e._delegate._internalPath;
}
var Nh = class {
  constructor(t2, e) {
...
var al = class {
  ...
  set(t2, e, n) {
    ...
    const s = hl(t2, this._firestore), i = ul(s.converter, e, n), r = lh(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
  ...
  update(t2, e, n, ...s) {
    ...
    let r;
    return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Za2 ? ph(this._dataReader, "WriteBatch.update", i._key, e, n, s) : yh(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r.toMutation(i._key, $n.exists(true))), this;
  }
  delete(t2) {
    this._verifyNotCommitted();
...
function dl(t2) {
  ...
  return oa2(n, t2._key).then((n2) => new kh(e, s, t2._key, n2, new Nh(
...
function yl(t2, e, n) {
  ...
  return Rl(s, [lh(hh(s), "setDoc", t2._key, i, null !== t2.converter, n).toMutation(t2._key, $n.none())]);
}
function pl(t2, e, n, ...s) {
  t2 = Ia2(t2, ba2);
  const i = Ia2(t2.firestore, Fa2), r = hh(i);
  let o;
  o = "string" == typeof (e = getModularInstance(e)) || e instanceof Za2 ? ph(r, "updateDoc", t2._key, e, n, s) : yh(r, "updateDoc", t2._key, e);
...
function El(t2, ...e) {
  ...
  "object" != typeof e[o] || ka2(e[o]) || (r = e[o], o++);
  const u = {
...
var Pl = class extends class {
  ...
  set(t2, e, n) {
    const s = hl(t2, this._firestore), i = ul(s.converter, e, n), r = lh(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    return this._transaction.set(s._key, r), this;
  }
  update(t2, e, n, ...s) {
    const i = hl(t2, this._firestore);
    let r;
    return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Za2 ? ph(this._dataReader, "Transaction.update", i._key, e, n, s) : yh(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r), this;
  }
  delete(t2) {
    const e = hl(t2, this._firestore);
  ...
  get(t2) {
    ...
    return super.get(t2).then((t3) => new kh(this._firestore, n, e._key, t3._document, new Nh(
      false,
      false
    ), e.converter));
  }
...
function kl(t2, e) {
  La2(t2 = Ia2(t2, Fa2));
  const n = "string" == typeof e ? function(t3) {
    var e2;
    try {
      return JSON.parse(t3);
    } catch (t4) {
      throw new Q2(G.INVALID_ARGUMENT, "Failed to parse JSON:" + (null === (e2 = t4) || void 0 === e2 ? void 0 : e2.message));
    }
  }(e) : e, s = [];
    ...
    for (const t3 of n.indexes) {
      ...
      if (Array.isArray(t3.fields))
        for (const e3 of t3.fields) {
          ...
          "CONTAINS" === e3.arrayConfig ? n2.push(new gt(t4, 2)) : "ASCENDING" === e3.order ? n2.push(new gt(t4, 0)) : "DESCENDING" === e3.order && n2.push(new gt(t4, 1));
        }
...
!function(t2, e = true) {
  ...
  }, "PUBLIC")), registerVersion(D2, "3.4.13", t2), registerVersion(D2, "3.4.13", "esm2017");
}();
...
* limitations under the License.
*/
//# sourceMappingURL=chunk-RQBNCX7X.js.map
