...
<!--  </div>-->
<!--  &lt;!&ndash;  <div>&ndash;&gt;-->
<!--  &lt;!&ndash;    <label for="customRange" class="form-label">Example range</label>&ndash;&gt;-->
<!--  &lt;!&ndash;    <input v-model="stepprice" type="range" class="form-range" min="0" max="20000" id="customRange">&ndash;&gt;-->
<!--  &lt;!&ndash;    <p style="text-align: center">{{stepprice}}</p>&ndash;&gt;-->
<!--  &lt;!&ndash;  </div>&ndash;&gt;-->
...
<!--          <li><a @click="brandbyamd" href="?kategory=arcelik" class="dropdown-item">arcelik</a></li>-->
